...
#    Updated: 2022/07/30 00:14:57 by ytijani          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2022/07/19 17:49:00 by ytijani           #+#    #+#              #
#    Updated: 2022/07/29 13:34:12 by ytijani          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
exec/ft_memcpy.c exec/ft_split.c exec/ft_strchr.c exec/ft_strlcpy.c exec/get_path.c exec/help_linkedlist.c exec/exec_cmd.c exec/utils.c  exec/handle_signals.c \
